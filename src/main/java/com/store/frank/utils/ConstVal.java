...
public interface ConstVal {
    ...
    String ENTITY_TEMPLATE = "/templates/entity.java.ftl";
    String MAPPER_TEMPLATE = "/templates/mapper.java.ftl";
    String XML_TEMPLATE = "/templates/mapper.xml.ftl";
    String SERVICE_TEMPLATE = "/templates/service.java.ftl";
    String SERVICE_IMPL_TEMPLATE = "/templates/serviceImpl.java.ftl";
    String CONTROLLER_TEMPLATE = "/templates/controller.java.ftl";
